...
>
> **M6 exit criteria — met. v1.2.0.** Four viewer-side tasks, `:core:parser` untouched exactly as predicted when the milestone was scoped. `versionCode 3`, `versionName 1.2.0`. The launcher icon redesigned last milestone ships here too, since it was deliberately held back from a tag of its own.
>
